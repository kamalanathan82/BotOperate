...
namespace BotOperate.Services
{
    public sealed class NotificationService : INotificationService
    {
        ...
        public async Task NotifyRecruiterAboutNewOpenPosition(Ticket position, CancellationToken cancellationToken = default)
        {
            var recruiter = _databaseContext.Recruiters.Find(position.AssignTo);
            ...
            var staticTabEntityId = "OpenTicketsTab"; // you can find this value in manifest definition
