...
//using BotOperate.Services.Refit;
...
//        public async Task<Team> CreateNewTeamForPosition(Ticket position, string token)
//        {
...
//            var group = await CreateGroup(graphClient, position.Ticketid, ownerIds, memberIds);
...
//        private static async Task AddAppToTeam(IGraphRestApiService graphClient, string teamId, string channelId, string teamsAppId, Ticket position)
//        {
...
//                var contentUrl = $"{ConfigurationManager.AppSettings["BaseUrl"]}/StaticViews/TeamTab.html?positionId={position.Ticketid}";
//                await graphClient.AddTab(teamId, channelId, new TeamsTab
//                {
//                    TeamsAppId = appId,
//                    DisplayName = position.Ticketid,
//                    Configuration = new TeamsTabConfiguration
//                    {
//                        EntityId = position.Ticketid.ToString(),
...
//        private async Task<string[]> GetTeamMemberIds(IGraphRestApiService graphClient, Ticket position, User requester)
//        {
//            var result = new HashSet<string>
//            {
//                requester.Id
//            };
//            //var hiringManager = position.AssignTo;
...
//        private static async Task<string[]> GetTeamOwnerIds(IGraphRestApiService graphClient, Ticket position, User requester)
//        {
//            var result = new HashSet<string>
//            {
//                requester.Id
